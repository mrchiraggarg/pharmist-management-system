...
<form class="content" action="delete_sell.php" method="POST">
	<div class="row">
		<div class="col-lg-12 col-md-12">
			<div class="card card-tasks">
				<div class="card-header ">
					<h6 class="title d-inline">Sell Information</h6>
					...
					<div class="dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
							<a class="dropdown-item" href="add_sell.php">
								<label class="btn btn-sm btn-primary btn-simple active" id="0">
									<span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Add new Sell</span>
							...
							<label class="btn btn-sm btn-primary btn-simple active" id="0">
								<span class="d-none d-sm-block d-md-block d-lg-block d-xl-block" >Delete Sells</span>
								<span class="d-block d-sm-none">
									<i class="tim-icons icon-single-02"></i>
								</span>
							</label>
					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td>
									<p class="title"><?php echo $data['customer_name']; ?></p>
									<p class="text-muted"><?php echo $data['customer_disease'];?></p>
								</td>
								<td class="td-actions text-right">
									<button type="button" rel="tooltip" title="" class="btn btn-link" data-original-title="Edit Task">
									<a href="update_sell.php?customer_id=<?php echo $data['customer_id']; ?>" >
